...
an.plot_avalanches(f1, label='Panic Collection=False', color='b', token='*', num_bins = 100, plot=True)
an.plot_avalanches(f2, label='Panic Collection=True', color='g', token='>', num_bins = 100, plot=True)
