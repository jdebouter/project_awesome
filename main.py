...
parameters = {"quick_repaying" : True,
              ...
              "too_big_to_fail" : False,  # This should be False by default
              "less_risk" : False,  # This should be False by default
...
network.graph['hubs'] = dn._find_hubs(network, parameters)
